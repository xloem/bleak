...
* New, advanced two devices example added.

Fixed
~~~~~

* Using ``timeout`` for connection timout as well as discovery timout in .NET backend.
* ``two_devices.py`` example got a correction.
